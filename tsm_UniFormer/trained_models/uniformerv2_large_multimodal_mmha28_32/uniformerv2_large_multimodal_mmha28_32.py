...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_prefix=dict(
            img='../../cls/VideoMamba-main/videomamba/video_sm/data/train'),
        pipeline=[
            dict(
                clip_len=32,
                frame_interval=4,
...
train_pipeline = [
    dict(clip_len=32, frame_interval=4, num_clips=1, type='SampleFrames'),
    dict(io_backend='disk', type='CustomRawFrameDecode'),
    dict(scale=(
        -1,
        256,
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_prefix=dict(
            img='../../cls/VideoMamba-main/videomamba/video_sm/data/val'),
        pipeline=[
            dict(
                clip_len=32,
                frame_interval=4,
...
work_dir = 'work_dirs/uniformerv2_large_multimodal_mmha28_32_interval4'
