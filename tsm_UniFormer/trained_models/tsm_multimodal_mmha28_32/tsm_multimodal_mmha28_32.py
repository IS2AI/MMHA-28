...
launcher = 'none'
load_from = 'work_dirs/tsm_multimodal_mmha28_32/best_acc_top1_epoch_95.pth'
log_level = 'INFO'
...
train_pipeline = [
    dict(clip_len=1, frame_interval=4, num_clips=32, type='SampleFrames'),
    dict(io_backend='disk', type='CustomRawFrameDecode'),
    dict(scale=(
        -1,
        256,
...
work_dir = './work_dirs/tsm_multimodal_mmha28_32'
