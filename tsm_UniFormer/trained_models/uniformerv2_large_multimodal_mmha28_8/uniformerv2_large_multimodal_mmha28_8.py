...
launcher = 'none'
load_from = 'work_dirs/uniformerv2_large_multimodal_mmha28_8/best_acc_top1_epoch_46.pth'
log_level = 'INFO'
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        pipeline=[
            dict(
                clip_len=8, frame_interval=4, num_clips=1,
                type='SampleFrames'),
            dict(io_backend='disk', type='CustomRawFrameDecode'),
            dict(scale=(
                -1,
...
train_pipeline = [
    dict(clip_len=8, frame_interval=4, num_clips=1, type='SampleFrames'),
    dict(io_backend='disk', type='CustomRawFrameDecode'),
    dict(scale=(
        -1,
        256,
...
work_dir = './work_dirs/uniformerv2_large_multimodal_mmha28_8'
