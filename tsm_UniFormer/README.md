# MMHA-28 Multimodal Customizations

This repository is an MMAction2 fork adapted for MMHA-28 multimodal action recognition. The current custom work keeps the original upstream documentation below, while the active project-specific pieces are summarized here.

**Active configs**

- **TSM**
  - `configs/recognition/tsm/tsm_multimodal_mmha28.py`
  - `configs/recognition/tsm/tsm_multimodal_mmha28_8.py`
  - `configs/recognition/tsm/tsm_multimodal_mmha28_16.py`
  - `configs/recognition/tsm/tsm_multimodal_mmha28_32.py`
  - `configs/recognition/tsm/tsm_multimodal_mmha28_event.py`
- **UniFormerV2-Large**
  - `configs/recognition/uniformerv2/uniformerv2_large_multimodal_mmha28_8.py`
  - `configs/recognition/uniformerv2/uniformerv2_large_multimodal_mmha28_16.py`
  - `configs/recognition/uniformerv2/uniformerv2_large_multimodal_mmha28_32.py`
- **UniFormerV2-Large evaluation overrides**
  - `configs/recognition/uniformerv2/uniformerv2_large_multimodal_mmha28_*_test.py`
  - `configs/recognition/uniformerv2/uniformerv2_large_multimodal_mmha28_*_test_office.py`
  - `configs/recognition/uniformerv2/uniformerv2_large_multimodal_mmha28_*_test_wild.py`
- **Single-modality UniFormerV2-Large variants**
  - `configs/recognition/uniformerv2/uniformerv2_large_multimodal_mmha28_8_rgb.py`
  - `configs/recognition/uniformerv2/uniformerv2_large_multimodal_mmha28_8_depth.py`
  - `configs/recognition/uniformerv2/uniformerv2_large_multimodal_mmha28_8_thermal.py`
  - `configs/recognition/uniformerv2/uniformerv2_large_multimodal_mmha28_8_event.py`

**Dataset and pipeline customizations**

- `mmaction/datasets/custom_multimodal_dataset.py`
  - supports TXT annotations and CSV test annotations
  - infers modality from folder structure
  - adds `DepthSyn` support for CSV-based evaluation
- Modality-filtered dataset wrappers
...
- Custom transforms and evaluation helpers
  - `mmaction/datasets/transforms/custom_loading.py`
  - `mmaction/datasets/transforms/normalize_per_modality.py`
  - `mmaction/datasets/transforms/normalize_rgb.py`
  - `mmaction/datasets/transforms/normalize_depth.py`
  - `mmaction/datasets/transforms/normalize_thermal.py`
  - `mmaction/datasets/transforms/normalize_event.py`
  - `mmaction/datasets/transforms/pack_with_modality.py`
  - `mmaction/datasets/transforms/skip_if_event.py`
  - `mmaction/evaluation/per_modality_acc.py`

**Notes**

- The previous MMHA-28 `TimeSformer` config has been removed.
- The `trained_models/` directory contains uploaded `TSM` and `UniFormerV2` model folders, including `trained_models/uniformerv2_large_multimodal_mmha28_{8,16,32}/` with UniFormerV2-Large model files and config snapshots.
- This repo already tracks `*.pth` with `Git LFS` via `.gitattributes`.

**How to train**
```bash
python tools/train.py configs/recognition/uniformerv2/uniformerv2_large_multimodal_mmha28_8.py
```

**How to test**
```bash
python tools/test.py configs/recognition/uniformerv2/uniformerv2_large_multimodal_mmha28_8_test.py /path/to/checkpoint.pth
```
