...
ann_file_train = 'dataset/train_depth_images.txt'
ann_file_val = 'dataset/val_depth_images.txt'
ann_file_test = 'dataset/test_depth_images.txt'

file_client_args = dict(io_backend='disk')

# Rawframe naming template
filename_tmpl = 'depth_{:04d}.png'
