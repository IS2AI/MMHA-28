...
ann_file_train = 'dataset/train_event-streams.txt'
ann_file_val = 'dataset/val_event-streams.txt'
ann_file_test = 'dataset/test_event-streams.txt'

file_client_args = dict(io_backend='disk')

# Rawframe naming template
filename_tmpl = 'frame_{:05d}.npy'
