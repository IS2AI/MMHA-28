# configs/uniformerv2_large_multimodal_mmha28_8_thermal.py
#
# Thermal UniFormerV2-Large for the MMHA-28 dataset.
# Trains and validates on Thermal data only, but tests on all modalities.
...
# ---------------------------------------------------------------------- #
#  Custom Python modules (Thermal for train/val, multimodal for test)
# ---------------------------------------------------------------------- #
custom_imports = dict(
    imports=[
        'mmaction.datasets.custom_thermal_dataset',
        'mmaction.datasets.custom_multimodal_dataset',
        'mmaction.datasets.transforms.custom_loading',
        'mmaction.datasets.transforms.normalize_thermal',
...
# ---------------------------------------------------------------------- #
dataset_type = 'CustomThermalDataset'  # For training and validation
