...
# ---------------------------------------------------------------------- #
#  Model settings (UniFormerV2-Large, 16 frames)
# ---------------------------------------------------------------------- #
num_frames = 16
num_classes = 28
...
ann_file_train = f'{data_root}/annotations_trainn.txt'
ann_file_val   = f'{data_root}/annotations_vall.txt'
...
# ---------------------------------------------------------------------- #
#  DataLoaders (reduced batch size for Large model + 16 frames)
# ---------------------------------------------------------------------- #
