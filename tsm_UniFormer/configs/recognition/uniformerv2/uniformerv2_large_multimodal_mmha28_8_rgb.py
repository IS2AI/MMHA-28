# configs/uniformerv2_large_multimodal_mmha28_8_rgb.py
#
# RGB UniFormerV2-Large for the MMHA-28 dataset.
# Trains and validates on RGB data only, but tests on all modalities.
...
# ---------------------------------------------------------------------- #
#  Custom Python modules (RGB for train/val, multimodal for test)
# ---------------------------------------------------------------------- #
custom_imports = dict(
    imports=[
        'mmaction.datasets.custom_rgb_dataset',
        'mmaction.datasets.custom_multimodal_dataset',
        'mmaction.datasets.transforms.custom_loading',
        'mmaction.datasets.transforms.normalize_rgb',
...
# ---------------------------------------------------------------------- #
dataset_type = 'CustomRGBDataset'  # For training and validation
