# configs/uniformerv2_large_multimodal_mmha28_8_depth.py
#
# Depth UniFormerV2-Large for the MMHA-28 dataset.
# Trains and validates on Depth data only, but tests on all modalities.
...
# ---------------------------------------------------------------------- #
#  Custom Python modules (Depth for train/val, multimodal for test)
# ---------------------------------------------------------------------- #
custom_imports = dict(
    imports=[
        'mmaction.datasets.custom_depth_dataset',
        'mmaction.datasets.custom_multimodal_dataset',
        'mmaction.datasets.transforms.custom_loading',
        'mmaction.datasets.transforms.normalize_depth',
...
# ---------------------------------------------------------------------- #
dataset_type = 'CustomDepthDataset'  # For training and validation
